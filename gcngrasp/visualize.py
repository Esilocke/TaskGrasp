...
def draw_scene(
    ...
    # if npz is not None:
    #         obj_stable_t = npz['obj_stable_translations']
    #         obj_stable_q = npz['obj_stable_quaternions']
    ...
    #         obj_transform = get_rot_matrix(obj_stable_t[0], obj_stable_q[0])

    #         def load_mesh(cat, idx, grasp_data_dir = '../../assets/urdf'):
    #             # load an object
    #             if cat in ['box', 'cylinder']:
    #                 mesh = trimesh.load(f'{grasp_data_dir}/meshes/{cat}/{cat}{idx:003}.stl')
    #             else:
    #                 obj_path = f'{grasp_data_dir}/meshes/{cat}/{cat}{idx:003}.obj'
    #                 f = open(obj_path, 'r')
    ...
    #             return mesh
    #         obj_mesh = load_mesh("bottle", 3).as_open3d
    #         meshes = [obj_mesh]
